...
export default function Footer() {
  return (
    <footer className="bg-white border border-slate-200 rounded-[2rem] mx-6 md:mx-auto max-w-7xl py-12 px-6 lg:px-12 mb-6 mt-10 w-[calc(100%-3rem)] md:w-full shadow-sm text-neutral-text">
      <div className="flex flex-col md:flex-row items-center justify-between">
         <div className="flex items-center gap-2 mb-4 md:mb-0">
            <div className="w-6 h-6 rounded bg-blue-700 flex items-center justify-center font-space font-bold text-xs text-white">R</div>
